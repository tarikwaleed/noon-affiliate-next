          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="bg-white shadow-lg rounded-lg p-6">
                <CardHeader className="flex flex-row-reverse  items-center">
                  <span className="text-xl font-semibold text-gray-900">
                    المشتري سيحصل على خصم
                  </span>
                  <span className="text-xl font-semibold text-gray-900 mr-1">
                    10
                  </span>
                ...
                <CardContent>
                  <p className="text-gray-600">
                    أنت إحتي الأرباح، من يستخدم الكود سيحصل على 10% على إيميلك
                    في قيمة مشترياته إذا كان مستخدم جديد، أو 5% على إيميلك إذا
                    كان مستخدم سابق.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white shadow-lg rounded-lg p-6">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    سنقوم بإنشاء كود خصم مميز خاص بك، عندما يستخدمه المشترون
                    أثناء مرحلة الدفع في نون ستحصل أنت على عمولة بنسبة1% من
                    إجمالي قيمة الطلب.{" "}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white shadow-lg rounded-lg p-6">
                <CardHeader>
                  <CardTitle className="text-xl font-semibold text-gray-900">
                    عروض مبيعات 1% مقابل كل طلب
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
                    برنامج زون التسويقي بالموقع يسمحكي من الربح مقابل كل طلب من
                    طلبك.
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="bg-gray-900 text-white py-8 px-4 md:px-6">
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-right">
                نحن فريق من المحترفين المتفانين الذين يشغفون بعملهم. نحن ملتزمون
                بتقديم منتجات وخدمات عالية الجودة لعملائنا.
              </p>
            </div>
          </div>
